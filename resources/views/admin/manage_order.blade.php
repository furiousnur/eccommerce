					...
					@foreach( $all_order_info as $v_order)
						  <tbody>
							<tr>
								...
								<td class="center">{{ $v_order->customer_id }}</td>
								...
								@endif
									...
									<a class="btn btn-danger" href="{{URL::to('/delete-order/'.$v_order->order_id )}}" id="delete" data-confirm="Are you sure want to delete this item?">
