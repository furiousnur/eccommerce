			...
			<form class="form-horizontal" action="{{URL::to('/save-category')}}" method="post">
				...
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="input" name="category_name" required="">
						</div>
					</div>

					<div class="control-group hidden-phone">
						<label class="control-label">Category Discripton</label>
						<div class="controls">
							<textarea class="" name="category_discripton" rows="3" required=""></textarea>
						</div>
					</div>
