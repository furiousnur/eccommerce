					...
					@foreach( $all_category_info as $v_category)
						  <tbody>
							<tr>
								...
								<td class="center">{{ $v_category->category_discripton }}</td>
								...
								@endif
									...
									<a class="btn btn-danger" href="{{URL::to('/delete-category/'.$v_category->category_id )}}" id="delete" data-confirm="Are you sure want to delete this item?">
