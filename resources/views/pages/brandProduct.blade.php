...
@section('content')
    ...
    <h2 class="title text-center">Features Items</h2>
            ...
            <?php foreach ($all_brand_product as $v_product) { ?> 
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($v_product->product_image)}}" alt="" style="height: 200px; width: 250px;"/>
                                        ...
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <img src="{{URL::to($v_product->product_image)}}" alt="" style="height: 100px; width: 100px;"/>
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        <li><i class="fa fa-plus-square"></i>{{$v_product->brand_name}}</li>
                                ...
                                <div class="item">  
                                    ...
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="{{URL::to('frontend/image/shome/recommend3.jpg')}}" alt="" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                                </div>
