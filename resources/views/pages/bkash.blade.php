			...
			<div class="row-fluid sortable">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <tbody>
							<tr>
								<td class="center">1. Bkash number: +8801724 575773</td>
							</tr>
							<tr>
								<td class="center">2. Dial *247# for bkash</td>
							</tr>
							<tr>
				...
				<div class="box span4">
					<div class="box-header" data-original-title>
						<h2 style="color: red;"><i class="halflings-icon user"></i><span class="break"></span>Given Bellow bkash txnId</h2>
					</div>
					<div class="box-content">
						<form action="{{URL::to('/bkash')}}" method="post">
							{{ csrf_field() }}
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  <thead>
								  <tr>
